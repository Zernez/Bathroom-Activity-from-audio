...
class PredictorDsn:
    ...
    def __init__(self):  
        ...
        self.img_x= 128
        self.img_y= 431        
        self.densenet_model_201 = densenet201()
        self.learning_rate = 2e-4
        self.optimizer = optim.Adam(self.densenet_model_201.parameters(), lr= self.learning_rate)
        self.densenet_model_201= self.load_model()

    def load_model(self):
        num_classes = len (self.activities)
        num_ftrs= 1920
        self.densenet_model_201.classifier= nn.Linear(num_ftrs, num_classes)
        self.densenet_model_201, optimizer= self.load_ckp('./models/densenet201.pth', self.densenet_model_201, self.optimizer)
        self.densenet_model_201.eval()
        return self.densenet_model_201
    ...
    def predict_model(self, last):
        ...
        pr= self.densenet_model_201.forward(spec_t)
