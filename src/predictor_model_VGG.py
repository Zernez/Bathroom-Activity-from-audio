...
class PredictorVGG:
    ...
    def __init__(self):  
        ...
        self.img_x= 128
        self.img_y= 431        
        self.vgg_model_19 = vgg19()
        self.learning_rate = 2e-4
        self.optimizer = optim.Adam(self.vgg_model_19.parameters(), lr= self.learning_rate)
        self.vgg_model_19= self.load_model()

    def load_model(self):
        num_classes = len (self.activities)
        num_ftrs= 4096
        self.vgg_model_19.classifier[6]= nn.Linear(num_ftrs, num_classes)
        self.vgg_model_19, optimizer= self.load_ckp('./models/vgg_19.pth', self.vgg_model_19, self.optimizer)
        self.vgg_model_19.eval()
        return self.vgg_model_19
    ...
    def predict_model(self, last):
        ...
        pr= self.vgg_model_19.forward(spec_t)
