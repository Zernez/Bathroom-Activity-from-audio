...
class PredictorEfc:
    ...
    def __init__(self):  
        ...
        self.img_x= 128
        self.img_y= 431        
        self.efficientnet_model_b7 = efficientnet_v2_l()
        self.learning_rate = 2e-4
        self.optimizer = optim.Adam(self.efficientnet_model_b7.parameters(), lr= self.learning_rate)
        self.efficientnet_model_b7= self.load_model()

    def load_model(self):
        num_classes = len (self.activities)
        num_ftrs= 1280
        self.efficientnet_model_b7.classifier[1]= nn.Linear(num_ftrs, num_classes)
        self.efficientnet_model_b7, optimizer= self.load_ckp('./models/efficientnet_b7.pth', self.efficientnet_model_b7, self.optimizer)
        self.efficientnet_model_b7.eval()
        return self.efficientnet_model_b7
    ...
    def predict_model(self, last):
        ...
        pr= self.efficientnet_model_b7.forward(spec_t)
